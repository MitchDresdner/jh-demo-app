package com.domconsulting.tics.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ticsdemo@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ticsdemo API";

        private String description = "ticsdemo API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ticsdemo";
